...
![alt img](text_analyser/assets/sys_architecture.png)

After clicking the analyse button the report(s) are generated for the same.

### Context Analysis

![alt img](text_analyser/assets/context.png)

### Sentiment Analysis

![alt img](text_analyser/assets/sentiment.png)

### Toxicity Analysis

![alt img](text_analyser/assets/toxicity.png)

### Overall Result Page

![alt img](text_analyser/assets/result.png)
